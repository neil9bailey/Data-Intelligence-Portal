...
param imageTag string = '1.0.65-cof-value-layer'
...
var appEnvironment = concat(
  [
    ...
    }
    {
      ...
      value: noticePageLimit
    }
    {
      name: 'DIP_NOTICE_MAX_PAGES'
      value: noticeMaxPages
    }
    {
    ...
    {
      name: 'DIP_AUTOPILOT_KRA_CUSTOMER_LIMIT'
      value: autopilotKraCustomerLimit
    }
    {
      name: 'DIP_AUTOPILOT_KRA_MAX_PAGES'
      value: autopilotKraMaxPages
    }
    {
      name: 'DIP_AUTOPILOT_KRA_CANDIDATES_PER_PAGE'
      value: autopilotKraCandidatesPerPage
    }
    {
      name: 'DIP_AUTOPILOT_MARKET_SWEEP_ENABLED'
      value: autopilotMarketSweepEnabled ? 'true' : 'false'
    }
    {
      name: 'DIP_AUTOPILOT_MARKET_SWEEP_LIMIT'
      value: autopilotMarketSweepLimit
    }
    {
      name: 'DIP_AUTOPILOT_MARKET_SWEEP_KEYWORDS'
      value: autopilotMarketSweepKeywords
    }
    {
      name: 'DIP_AUTOPILOT_CLASSIFICATION_ENABLED'
      value: autopilotClassificationEnabled ? 'true' : 'false'
    }
    {
